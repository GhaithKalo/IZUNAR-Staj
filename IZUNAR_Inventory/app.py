...
from models import db, User, Component, BorrowLog, Project, ProjectItem, Tag
...
def create_project():
    ...
    if request.method == 'POST':
        ...
        # Malzemeleri projeye ekle
        for comp_id, amount in zip(selected_items, amounts):
            if int(amount) > 0:
    ...
    return render_template('create_project.html', components=components)
